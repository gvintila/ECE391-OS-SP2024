...
/* We need to have paging know where video memory is so we move VIDEO here */

/* Location in physical memory for video memory is located */
#define VIDEO       0xB8000

/* Putting this here so that C doesn't yell at me */
